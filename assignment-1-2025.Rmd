...
author: "Yahya Al Salmi, B00895877"
date: "`r Sys.Date()`"
output:
...
-->
The scatterplot shows the relationship between bill length and bill depth for penguins, with most points clustered in distinct groups, but there doesn’t appear to be a single clear trend across all species.
...
The updated plot shows that the three penguin species have their own clusters, meaning their bill length and depth are different for each species.
